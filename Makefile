...
MODNAMES=        _thread posix errno pwd _sre _codecs _weakref _functools _operator _collections itertools atexit _signal _stat time _locale _io zipimport faulthandler _tracemalloc _symtable readline zlib xxsubtype
MODOBJS=          Modules/_threadmodule.o  Modules/posixmodule.o  Modules/errnomodule.o  Modules/pwdmodule.o  Modules/_sre.o  Modules/_codecsmodule.o  Modules/_weakref.o  Modules/_functoolsmodule.o  Modules/_operator.o  Modules/_collectionsmodule.o  Modules/itertoolsmodule.o  Modules/atexitmodule.o  Modules/signalmodule.o  Modules/_stat.o  Modules/timemodule.o  Modules/_localemodule.o  Modules/_iomodule.o Modules/iobase.o Modules/fileio.o Modules/bytesio.o Modules/bufferedio.o Modules/textio.o Modules/stringio.o  Modules/zipimport.o  Modules/faulthandler.o  Modules/_tracemalloc.o Modules/hashtable.o  Modules/symtablemodule.o  Modules/readline.o  Modules/zlibmodule.o  Modules/xxsubtype.o
...
abs_srcdir=	/home/pni/vmshare/Python-3.6.0
abs_builddir=	/home/pni/vmshare/Python-3.6.0
...
CONFIG_ARGS=	 '--prefix=/home/pni/install'
...
LOCALMODLIBS=                       -lreadline -ltermcap  -L$(exec_prefix)/lib -lz 
BASEMODLIBS=
...
Modules/readline.o: $(srcdir)/Modules/readline.c; $(CC) $(PY_CORE_CFLAGS)  -c $(srcdir)/Modules/readline.c -o Modules/readline.o
Modules/readline$(EXT_SUFFIX):  Modules/readline.o; $(BLDSHARED)  Modules/readline.o  -lreadline -ltermcap  -o Modules/readline$(EXT_SUFFIX)
